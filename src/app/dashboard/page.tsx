            ...
            {!recentLeads?.length ? (
              <div className="rounded-2xl border border-dashed p-8 text-center">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Create a demo lead or connect your Twilio number to start
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-5 space-y-3 text-sm text-slate-600">
              <p>
                <strong>Next:</strong> Complete a test call, review the
                transcript, and confirm notifications.
              </p>
              <p>
                Do not route real business calls until the test call is
                successful.
              </p>
            </div>
          </CardContent>
        ...
        <CardContent>
          <div className="rounded-2xl bg-slate-950 p-6 text-white">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              <ProofMetric label="Booked revenue" value={`$${bookedRevenue.toLocaleString()}`} />
